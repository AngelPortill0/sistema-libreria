...
public class Autores extends javax.swing.JFrame {
  ...
  private void initComponents() {
    ...
    Tdeseleccionar.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    btnGenerarReporte.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
  ...
  private void TdeseleccionarActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_TdeseleccionarActionPerformed
    Tnombre.setText("");
    Tapellido.setText("");
    Tbiografia.setText("");
  ...
  private void btnGenerarReporteActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_btnGenerarReporteActionPerformed
    var autorDAO = new AutorDAO();
    var autoresNumPublicaciones = autorDAO.generarAutoresConPublicaciones();

    var reporte = new Reporte(autoresNumPublicaciones, "reporte_autores_num_publicaciones");
    try {
      reporte.graficar("Reporte Autores con más Publicaciones");
