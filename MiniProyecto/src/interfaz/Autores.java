...
public class Autores extends javax.swing.JFrame {
  ...
  void editar() {
      ...
      String sql = "update persona set Nombre = '"+Nombre+"', Apellido = '"+Apellido+"', Fecha de nacimiento = '"+Fnacimiento+"', Número de publicaciones = '"+Npublicaciones+"', Biografia = '"+Biografia+"'";   
      
      if(Nombre.equals("") || Apellido.equals("") || Fnacimiento.equals("") || Npublicaciones.equals("") || Biografia.equals("")) {
  ...
  private void agregarActionPerformed(
    ...
    if (nombre.equals("")
      ...
      JOptionPane.showMessageDialog(null, "Los campos estan vacios!!!");
        ...
        String sql = "insert into persona(Nombre, Apellido, Fecha de nacimiento, Número de Publicaciones, Biografia)values('"+nombre+"','"+apellido+"','"+fnacimiento+"','"+publicaciones+"','"+biografia+"')";
